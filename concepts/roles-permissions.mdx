---
title: "Roles and Permissions in Cole"
...
<CardGroup cols={1}>
  <Card title="super-admin" icon="crown">
    Platform-level administrator. Has no `tenant_id`, so all Eloquent global scopes are bypassed. Can create and manage tenants, assign modules, and access any endpoint across every school account.
  </Card>
...
<Accordion title="super-admin — Platform Administrator">
  ...
  - The `BelongsToTenant` global scope does **not** apply — queries return records from all tenants.
