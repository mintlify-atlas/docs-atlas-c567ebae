...
sidebarTitle: "Auth"
description: "Endpoints for user registration, login with Sanctum token rotation, logout, and fetching the authenticated user's full profile and assigned roles."
---
